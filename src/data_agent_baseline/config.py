...
def load_app_config(config_path: Path) -> AppConfig:
    ...
    raw_temperature = agent_payload.get("temperature")
    raw_reasoning_effort = agent_payload.get("reasoning_effort")
    agent_config = AgentConfig(
        ...
        reasoning_effort=str(raw_reasoning_effort) if raw_reasoning_effort is not None else None,
    )
